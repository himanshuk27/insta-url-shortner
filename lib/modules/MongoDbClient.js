...
var url = process.env.MONGODB_URL || "127.0.0.1";
...
function () {
    ...
    return _regenerator.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            return _context3.abrupt("return", collection.insertOne(item));
  ...
  return function insertItem(_x4) {
    ...
    return _regenerator.default.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            return _context4.abrupt("return", collection.findOne(query));
